// data/md3.js - מחזור 3 (תשתית המבוססת על לוח המשחקים שסופק)
...
const matchday3Database = {
    ...
    'match49': {
        ...
        advancedStats: { home: { xG: '1.80', restDays: 5, altitudeImpact: 'רגיל' }, away: { xG: '1.20', restDays: 5, altitudeImpact: 'רגיל' } },
    ...
    'match50': {
        ...
        advancedStats: { home: { xG: '1.30', restDays: 5, altitudeImpact: 'רגיל' }, away: { xG: '0.60', restDays: 5, altitudeImpact: 'מארחת' } },
    ...
    'match53': {
        ...
        teamAway: { name: 'דרום קוריאה', flagCode: 'kr', color: '#C60C30', cards: { yellow: [], red: [] } },
