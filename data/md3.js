...
const matchday3Database = {
    ...
    'match50': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.96 שערים לדרום אפריקה מול 1.48 לקוריאה הדרומית.`, actual: `יש לקוריאה הדרומית עדיפות קלה על הנייר (xG 1.48 מול 0.96), אך זהו בהחלט לא משחק חד-צדדי. המפתח כאן יהיה המאבק על האמצע: אם דרום אפריקה תצליח לשבור את קווי המסירה של המארחת, היא יכולה להפתיע.` },
        goals: [],
    ...
    'match51': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.36 שערים לשווייץ מול 1.0 לקנדה.`, actual: `יש לשווייץ עדיפות קלה על הנייר (xG 1.36 מול 1.0), אך זהו בהחלט לא משחק חד-צדדי. המפתח כאן יהיה המאבק על האמצע: אם קנדה תצליח לשבור את קווי המסירה של המארחת, היא יכולה להפתיע.` },
        goals: [],
    ...
    'match52': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.3 שערים לבוסניה והרצגובינה מול 1.22 לקטאר.`, actual: `איזה קרב אדיר הולך להיות לנו כאן! שוויון כוחות כמעט מוחלט בפרמטרים הסטטיסטיים (xG של 1.3 מול 1.22). במשחקים צמודים וטקטיים שכאלו, הכל יקום וייפול על טעויות קטנות, ואולי על הברקה אישית אחת שתשבור את הקרח.` },
        goals: [],
    ...
    'match53': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.62 שערים לסקוטלנד מול 2.4 לברזיל.`, actual: `הבדלי הרמות כאן זועקים לשמיים. ברזיל פייבוריטית מוחלטת עם צפי ל-2.4 שערים לעומת 0.62 בלבד של המארחת. אם סקוטלנד רוצה להוציא משהו מהמשחק הזה, היא תהיה חייבת לגרור את ברזיל למשחק פיזי, אגרסיבי, ולהרוס את שטף המשחק.` },
        goals: [],
    ...
    'match54': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.83 שערים למרוקו מול 0.71 להאיטי.`, actual: `לא צריך להיות גאון כדורגל כדי להבין שמרוקו עולה לכאן כפייבוריטית מובהקת (מודל ה-xG מעניק לה יתרון של 1.83 שערים צפויים לעומת 0.71). אני צופה שמרוקו תשלוט במרכז השדה ותכתיב את הקצב, בעוד שהאיטי תיאלץ להתגונן נמוך, לספוג לחץ, ולנסות לעקוץ במתפרצות מתואמות.` },
        goals: [],
    ...
    'match55': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.88 שערים לטורקיה מול 1.57 לארצות הברית.`, actual: `ארצות הברית אמורה לשלוט בקצב המשחק (xG 1.57), בזמן שטורקיה צפויה להגן נמוך ולחפש הזדמנויות דרך משחק מעברים מהיר.` },
        goals: [],
    ...
    'match56': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.03 שערים לפרגוואי מול 1.37 לאוסטרליה.`, actual: `יש לאוסטרליה עדיפות קלה על הנייר (xG 1.37 מול 1.03), אך זהו בהחלט לא משחק חד-צדדי. המפתח כאן יהיה המאבק על האמצע: אם פרגוואי תצליח לשבור את קווי המסירה של המארחת, היא יכולה להפתיע.` },
        goals: [],
    ...
    'match57': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.16 שערים לקוראסאו מול 1.39 לחוף השנהב.`, actual: `איזה קרב אדיר הולך להיות לנו כאן! שוויון כוחות כמעט מוחלט בפרמטרים הסטטיסטיים (xG של 1.16 מול 1.39). במשחקים צמודים וטקטיים שכאלו, הכל יקום וייפול על טעויות קטנות, ואולי על הברקה אישית אחת שתשבור את הקרח.` },
        goals: [],
    ...
    'match58': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.83 שערים לאקוודור מול 1.52 לגרמניה.`, actual: `גרמניה אמורה לשלוט בקצב המשחק (xG 1.52), בזמן שאקוודור צפויה להגן נמוך ולחפש הזדמנויות דרך משחק מעברים מהיר.` },
        goals: [],
    ...
    'match59': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.49 שערים ליפן מול 0.84 לשוודיה.`, actual: `יש ליפן עדיפות קלה על הנייר (xG 1.49 מול 0.84), אך זהו בהחלט לא משחק חד-צדדי. המפתח כאן יהיה המאבק על האמצע: אם שוודיה תצליח לשבור את קווי המסירה של המארחת, היא יכולה להפתיע.` },
        goals: [],
    ...
    'match60': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.7 שערים לתוניסיה מול 1.98 להולנד.`, actual: `הבדלי הרמות כאן זועקים לשמיים. הולנד פייבוריטית מוחלטת עם צפי ל-1.98 שערים לעומת 0.7 בלבד של המארחת. אם תוניסיה רוצה להוציא משהו מהמשחק הזה, היא תהיה חייבת לגרור את הולנד למשחק פיזי, אגרסיבי, ולהרוס את שטף המשחק.` },
        goals: [],
    ...
    'match61': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.02 שערים למצרים מול 1.34 לאיראן.`, actual: `יש לאיראן עדיפות קלה על הנייר (xG 1.34 מול 1.02), אך זהו בהחלט לא משחק חד-צדדי. המפתח כאן יהיה המאבק על האמצע: אם מצרים תצליח לשבור את קווי המסירה של המארחת, היא יכולה להפתיע.` },
        goals: [],
    ...
    'match62': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.73 שערים לניו זילנד מול 1.94 לבלגיה.`, actual: `הבדלי הרמות כאן זועקים לשמיים. בלגיה פייבוריטית מוחלטת עם צפי ל-1.94 שערים לעומת 0.73 בלבד של המארחת. אם ניו זילנד רוצה להוציא משהו מהמשחק הזה, היא תהיה חייבת לגרור את בלגיה למשחק פיזי, אגרסיבי, ולהרוס את שטף המשחק.` },
        goals: [],
    ...
    'match63': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.24 שערים לכף ורדה מול 1.26 לערב הסעודית.`, actual: `איזה קרב אדיר הולך להיות לנו כאן! שוויון כוחות כמעט מוחלט בפרמטרים הסטטיסטיים (xG של 1.24 מול 1.26). במשחקים צמודים וטקטיים שכאלו, הכל יקום וייפול על טעויות קטנות, ואולי על הברקה אישית אחת שתשבור את הקרח.` },
        goals: [],
    ...
    'match64': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.77 שערים לאורוגוואי מול 1.75 לספרד.`, actual: `ספרד אמורה לשלוט בקצב המשחק (xG 1.75), בזמן שאורוגוואי צפויה להגן נמוך ולחפש הזדמנויות דרך משחק מעברים מהיר.` },
        goals: [],
        squads: { home: { predicted: ['Sergio Rochet', 'José Giménez', 'Sebastián Cáceres', 'Ronald Araújo', 'Manuel Ugarte', 'Rodrigo Bentancur', 'Nicolás de la Cruz', 'Federico Valverde', 'Darwin Núñez', 'Giorgian de Arrascaeta', 'Facundo Pellistri'], actual: [] }, away: { predicted: ['David Raya', 'Marc Pubill', 'Álex Grimaldo', 'Eric García', 'Marcos Llorente', 'Mikel Merino', 'Ferran Torres', 'Fabián Ruiz', 'Gavi', 'Dani Olmo', 'Yéremy Pino'], actual: [] } }
    },
    'match65': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.9 שערים לנורבגיה מול 1.59 לצרפת.`, actual: `צרפת אמורה לשלוט בקצב המשחק (xG 1.59), בזמן שנורבגיה צפויה להגן נמוך ולחפש הזדמנויות דרך משחק מעברים מהיר.` },
        goals: [],
    ...
    'match66': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.61 שערים לסנגל מול 0.87 לעיראק.`, actual: `יש לסנגל עדיפות קלה על הנייר (xG 1.61 מול 0.87), אך זהו בהחלט לא משחק חד-צדדי. המפתח כאן יהיה המאבק על האמצע: אם עיראק תצליח לשבור את קווי המסירה של המארחת, היא יכולה להפתיע.` },
        goals: [],
    ...
    'match67': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.98 שערים לאלג'יריה מול 1.31 לאוסטריה.`, actual: `יש לאוסטריה עדיפות קלה על הנייר (xG 1.31 מול 0.98), אך זהו בהחלט לא משחק חד-צדדי. המפתח כאן יהיה המאבק על האמצע: אם אלג'יריה תצליח לשבור את קווי המסירה של המארחת, היא יכולה להפתיע.` },
        goals: [],
    ...
    'match68': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.59 שערים לירדן מול 2.57 לארגנטינה.`, actual: `הבדלי הרמות כאן זועקים לשמיים. ארגנטינה פייבוריטית מוחלטת עם צפי ל-2.57 שערים לעומת 0.59 בלבד של המארחת. אם ירדן רוצה להוציא משהו מהמשחק הזה, היא תהיה חייבת לגרור את ארגנטינה למשחק פיזי, אגרסיבי, ולהרוס את שטף המשחק.` },
        goals: [],
    ...
    'match69': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.89 שערים לקולומביה מול 1.49 לפורטוגל.`, actual: `פורטוגל אמורה לשלוט בקצב המשחק (xG 1.49), בזמן שקולומביה צפויה להגן נמוך ולחפש הזדמנויות דרך משחק מעברים מהיר.` },
        goals: [],
    ...
    'match70': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.29 שערים לקונגו מול 1.24 לאוזבקיסטן.`, actual: `איזה קרב אדיר הולך להיות לנו כאן! שוויון כוחות כמעט מוחלט בפרמטרים הסטטיסטיים (xG של 1.29 מול 1.24). במשחקים צמודים וטקטיים שכאלו, הכל יקום וייפול על טעויות קטנות, ואולי על הברקה אישית אחת שתשבור את הקרח.` },
        goals: [],
    ...
    'match71': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 0.59 שערים לפנמה מול 2.61 לאנגליה.`, actual: `הבדלי הרמות כאן זועקים לשמיים. אנגליה פייבוריטית מוחלטת עם צפי ל-2.61 שערים לעומת 0.59 בלבד של המארחת. אם פנמה רוצה להוציא משהו מהמשחק הזה, היא תהיה חייבת לגרור את אנגליה למשחק פיזי, אגרסיבי, ולהרוס את שטף המשחק.` },
        goals: [],
    ...
    'match72': {
        ...
        insight: { prediction: `על הנייר: הסתברות פואסון חזתה 1.69 שערים לקרואטיה מול 0.79 לגאנה.`, actual: `לא צריך להיות גאון כדורגל כדי להבין שקרואטיה עולה לכאן כפייבוריטית מובהקת (מודל ה-xG מעניק לה יתרון של 1.69 שערים צפויים לעומת 0.79). אני צופה שקרואטיה תשלוט במרכז השדה ותכתיב את הקצב, בעוד שגאנה תיאלץ להתגונן נמוך, לספוג לחץ, ולנסות לעקוץ במתפרצות מתואמות.` },
        goals: [],
