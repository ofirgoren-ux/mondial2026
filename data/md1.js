// קובץ נתונים: מחזור 1 (Matchday 1) - 24 משחקים שהסתיימו
const matchDatabase = {
    'match1': {
    ...
    'match17': {
        timeStatus: 'past', stage: 'I', dateText: "בית ט' | 16 ביוני",
    ...
    'match21': {
        timeStatus: 'past', stage: 'L', dateText: "בית ל' | 17 ביוני",
    ...
    'match22': {
        timeStatus: 'past', stage: 'K', dateText: "בית כ' | 17 ביוני",
        ...
        probabilities: { home: 75, draw: 15, away: 10 },
        matchRisk: 'Safe',
    ...
    'match23': {
        ...
        insight: { prediction: "גאנה פייבוריטית, אבל פנמה מסוכנת מאוד במתפרצות.", actual: "פגיעה במגמה! גאנה עמדה בלחץ ושמרה על רשת נקייה בדרך לניצחון קטן וחשוב." },
