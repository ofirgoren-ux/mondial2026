...
const knockoutMatches = {
    ...
    'match98': { 
        ...
        advancedStats: { home: { xG: '1.40', corners: 0 }, away: { xG: '1.70', corners: 0 } }, 
        insight: { 
            prediction: `התנגשות אדירה בין המכונה ההתקפית של נורווגיה והאלנד לבין האופי והווינריות של אנגליה במאני-טיים. הסטטיסטיקה מראה שוויון כמעט מוחלט, אך יעילות הקישור האנגלי והניסיון במעמדים אלו עשויים להעניק לאנגלים ניצחון דרמטי על חודו של גול במשחק שיוכרע בפרטים הקטנים של השליש האחרון.`, 
    ...
    'match101': { 
        ...
        insight: { 
            ...
            actual: `איזו תצוגת תכלית ספרדית! לה רוחה מפרקת את חומת ההגנה הצרפתית ורושמת ניצחון 2-0 חלק ב-90 דקות, בניגוד מוחלט לתחזית המודל שלנו. מיקל אויארסבאל נתן את האות לחגיגה WITH שער מוקדם בדקה ה-22, ופדרו פורו (58') סגר את הסיפור במחצית השנייה. הטיקי-טאקה ניצח את המתפרצות, וספרד היא העולה הראשונה לגמר הגדול!` 
        }, 
        goals: [] 
    },
    'match102': { 
        ...
        insight: { 
            ...
            actual: `מחצית ראשונה מאופסת וטקטית התפוצצה לדרמת ענק במחצית השנייה. אנתוני גורדון העלה את האנגלים ליתרון (55'), אבל אלופת העולם הוכיחה ששוב אופי מברזל. אנסו פרננדס השווה בדקה ה-86, ולאוטרו מרטינס השלים מהפך דרמטי עמוק בתוספת הזמן (90+2') ששולח את ארגנטינה לגמר מול ספרד. בינגו מושלם של המודל בתחזית!` 
        }, 
        goals: [] 
    },
'match103': { 
        timeStatus: 'past', matchday: 'final', stage: "מקום שלישי", dateText: `19/07/2026 | 00:00 (שעון ישראל)`, 
        teamHome: { name: `צרפת`, flagCode: 'fr', color: '#002654', cards: { yellow: [], red: [] } }, 
        teamAway: { name: `אנגליה`, flagCode: 'gb-eng', color: '#FFFFFF', cards: { yellow: [], red: [] } }, 
        score: { prediction: '3 - 2', actual: '4 - 6', accuracyClass: 'wrong' }, 
        ...
        insight: { 
            prediction: `משחק על המקום השלישי הוא תמיד חגיגה התקפית ומשוחררת מלחצים. שתי מעצמות אירופאיות שמגיעות עם כבוד פגוע אחרי ההדחה בחצי הגמר ירצו לסיים את הטורניר בטעם מתוק. צרפת מחזיקה ביתרון של עומק בספסל ואיכות יצירת מצבים (xG גבוה), ואנחנו צופים כאן משחק פתוח ורווי שערים שבו הטריקולור יצאו כשידם על העליונה בסופו של דבר.`, 
            actual: `איזה תסריט פסיכי! אנגליה פתחה בסערה ודרסה את צרפת עם 4-0 מדהים כבר במחצית הראשונה, כולל צמד של בוקאיו סאקה ושערים מוקדמים של רייס וקונסה. הצרפתים סירבו לוותר ופתחו בקאמבק מטורף במחצית השנייה עם צמד של אמבפה ושער של ברקולה שצימקו ל-4-3. בדקה ה-87 סאקה השלים שלושער אדיר שנתן אוויר לאנגלים. גם שער מאוחר של דמבלה עמוק בתוספת הזמן (90+6') לא הספיק, לפני שג'וד בלינגהאם (90+8') חתם את תוצאת המשחק המשוגעת הזו והעניק לאנגליה את מדליית הארד עם 6-4 היסטורי.` 
        }, 
        goals: [] 
    },
    'match104': { 
