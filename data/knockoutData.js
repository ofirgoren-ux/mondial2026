...
window.knockoutBracket = {
    ...
    roundOf16: [
        ...
        { team1: { name: 'מנצחת 83', flag: '', score: '-', outcome: 'pending' }, team2: { name: 'מנצחת 84', flag: '', score: '-', outcome: 'pending' } },
        { team1: { name: 'מנצחת 86', flag: '', score: '-', outcome: 'pending' }, team2: { name: 'מנצחת 88', flag: '', score: '-', outcome: 'pending' } },
        { team1: { name: 'מנצחת 85', flag: '', score: '-', outcome: 'pending' }, team2: { name: 'מנצחת 87', flag: '', score: '-', outcome: 'pending' } }
    ]
};
