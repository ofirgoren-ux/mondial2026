...
'match74': { 
    ...
    'match79': { timeStatus: 'future', matchday: 'r32', stage: "נוקאאוט", dateText: `01/07/2026 | 04:00 (שעון ישראל)`, teamHome: { name: `מקסיקו`, flagCode: 'mx', color: '#006341', cards: { yellow: [], red: [] } }, teamAway: { name: `אקוודור`, flagCode: 'ec', color: '#FFD100', cards: { yellow: [], red: [] } }, score: { prediction: '3 - 1', actual: '', accuracyClass: 'pending' }, probabilities: { home: 55, draw: 25, away: 20 }, matchRisk: 'Standard', radarStats: { home: [80, 75, 70, 85, 75, 75], away: [65, 60, 55, 70, 75, 60] }, advancedStats: { home: { xG: '2.10', corners: 0 }, away: { xG: '0.80', corners: 0 } }, insight: { prediction: `שתי נבחרות עם המון אמוציות וקהל אדיר. אקוודור הראתה נגד גרמניה שאין לה רגשי נחיתות. צפוי משחק סוער.`, actual: `` }, goals: [] },
    ...
    'match83': { timeStatus: 'future', matchday: 'r32', stage: "נוקאאוט", dateText: `02/07/2026 | 22:00 (שעון ישראל)`, teamHome: { name: `ספרד`, flagCode: 'es', color: '#C60B1E', cards: { yellow: [], red: [] } }, teamAway: { name: `אוסטריה`, flagCode: 'at', color: '#EF3340', cards: { yellow: [], red: [] } }, score: { prediction: '2 - 0', actual: '', accuracyClass: 'pending' }, probabilities: { home: 65, draw: 25, away: 10 }, matchRisk: 'Safe', radarStats: { home: [90, 92, 75, 85, 75, 88], away: [70, 65, 60, 75, 75, 65] }, advancedStats: { home: { xG: '2.10', corners: 0 }, away: { xG: '0.60', corners: 0 } }, insight: { prediction: `הטיקי-טאקה הספרדי אמור להתיש את הלחץ האוסטרי ולמצוא את הרשת במוקדם או במאוחר.`, actual: `` }, goals: [] },
    'match84': { timeStatus: 'future', matchday: 'r32', stage: "נוקאאוט", dateText: `03/07/2026 | 02:00 (שעון ישראל)`, teamHome: { name: `פורטוגל`, flagCode: 'pt', color: '#E42518', cards: { yellow: [], red: [] } }, teamAway: { name: `קרואטיה`, flagCode: 'hr', color: '#FF0000', cards: { yellow: [], red: [] } }, score: { prediction: '1 - 1', actual: '', accuracyClass: 'pending' }, probabilities: { home: 40, draw: 35, away: 25 }, matchRisk: 'Draw Booster', radarStats: { home: [82, 78, 75, 80, 70, 85], away: [80, 82, 70, 85, 72, 80] }, advancedStats: { home: { xG: '1.20', corners: 0 }, away: { xG: '1.15', corners: 0 } }, insight: { prediction: `משחק טקטי ברמה הגבוהה ביותר. קרואטיה תשלוט במרכז המגרש, בעוד פורטוגל תחפש את הכישרון האישי. פוטנציאל גבוה להארכה ופנדלים.`, actual: `` }, goals: [] },
    'match85': { timeStatus: 'future', matchday: 'r32', stage: "נוקאאוט", dateText: `03/07/2026 | 06:00 (שעון ישראל)`, teamHome: { name: `שווייץ`, flagCode: 'ch', color: '#FF0000', cards: { yellow: [], red: [] } }, teamAway: { name: `אלג'יריה`, flagCode: 'dz', color: '#006233', cards: { yellow: [], red: [] } }, score: { prediction: '1 - 0', actual: '', accuracyClass: 'pending' }, probabilities: { home: 50, draw: 30, away: 20 }, matchRisk: 'Safe', radarStats: { home: [75, 70, 65, 75, 70, 75], away: [70, 65, 60, 70, 75, 65] }, advancedStats: { home: { xG: '1.40', corners: 0 }, away: { xG: '0.90', corners: 0 } }, insight: { prediction: `שווייץ בוגרת ומנוסה מאוד במשחקי נוקאאוט. אלג'יריה תנסה להפתיע אך השווייצרים פייבוריטים לעלות.`, actual: `` }, goals: [] },
