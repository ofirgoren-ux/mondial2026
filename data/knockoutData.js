...
const knockoutMatches = {
    ...
    'match86': { 
        ...
        insight: { prediction: `קרב שקול וקשוח. הפיזיות האוסטרלית מול הטכניקה המצרית. משחק שיכול להיות מוכרע בטעות בודדת.`, actual: `מצרים רושמת הישג אדיר ומעפילה לשמינית הגמר אחרי ניצחון קשה על אוסטרליה. הטכניקה הכריעה את הפיזיות.` }, 
        goals: [] 
    },
    'match87': { 
        ...
        insight: { prediction: `הסינדרלה מכף ורדה פוגשת את אלופת העולם. מסע הקסם כנראה יסתיים כאן מול מסי וחבריו.`, actual: `בינגו של המודל. ארגנטינה לא התקשתה וטיילה לשלב הבא עם תצוגת כדורגל דומיננטית.` }, 
        goals: [] 
    },
    'match88': { 
        ...
        insight: { prediction: `קולומביה מגיעה כפייבוריטית בזכות הכישרון ההתקפי, אך תצטרך להתמודד עם המהירות העצומה של גאנה.`, actual: `עוד פגיעה מדויקת. הכישרון הקולומביאני גבר על המהירות של גאנה במשחק קצבי ומרתק.` }, 
        goals: [] 
    },
    'match89': { 
        ...
        advancedStats: { home: { xG: '1.10', corners: 0 }, away: { xG: '1.40', corners: 0 } }, 
        insight: { prediction: `קנדה מגיעה לשמינית הגמר על גלי התלהבות אחרי קאמבק דרמטי. מנגד, מרוקו מציגה ניסיון עשיר במעמדים האלה וסגל שמורגל ללחץ. המודל מזהה יתרון קל לאריות האטלס במרכז השדה, אך מזהיר מהמהירות הקטלנית של הקנדים במתפרצות. צפוי משחק טקטי שיוכרע בפרטים הקטנים.`, actual: `הצהרת כוונות מהדהדת של אריות האטלס! מרוקו פירקה את קנדה עם 3-0 מוחץ. הניסיון והעוצמה המרוקאית במרכז השדה פשוט העלימו את המהירות הקנדית מהרגע הראשון.` }, goals: [] 
    },
    'match90': { 
        ...
        insight: { prediction: `נבחרת הטריקולור פייבוריטית ברורה במשחק הזה, עם עומק סגל שאין שני לו בטורניר. פרגוואי תגיע במטרה להסתגר, לבנות חומת מגן כפולה ולעקוץ במצבים נייחים. עם זאת, מדדי האיכות מצביעים על כך שהלחץ הצרפתי יכריע את ההתמודדות במוקדם או במאוחר.`, actual: `יעילות צרפתית קלאסית. הטריקולור הסתפקו בשער בודד כדי לשבור את חומת המגן של פרגוואי בדרך לרבע הגמר, בדיוק בהתאם למגמה שחזה המודל.` }, goals: [] 
    },
    'match91': { 
