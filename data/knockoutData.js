...
const knockoutMatches = {
    ...
    'match80': { timeStatus: 'past', matchday: 'r32', stage: "נוקאאוט", dateText: `01/07/2026 | 19:00 (שעון ישראל)`, teamHome: { name: `אנגליה`, flagCode: 'gb-eng', color: '#FFFFFF', cards: { yellow: [], red: [] } }, teamAway: { name: `קונגו`, flagCode: 'cd', color: '#007A5E', cards: { yellow: [], red: [] } }, score: { prediction: '2 - 1', actual: '2 - 1', accuracyClass: 'exact' }, probabilities: { home: 65, draw: 22, away: 13 }, matchRisk: 'Upset Alert', radarStats: { home: [80, 75, 70, 78, 82, 88], away: [68, 55, 60, 75, 85, 60] }, advancedStats: { home: { xG: '1.90', corners: 0 }, away: { xG: '0.95', corners: 0 } }, insight: { prediction: `תומאס טוכל הבטיח שאנגליה תיראה טוב יותר אחרי הופעה פושרת בשלב הבתים. קונגו הראתה אופי אדיר עם קאמבק מרשים, והיא תקשה מאוד על האנגלים עם פיזיות במרכז השדה.`, actual: `אנגליה הזיעה אך עשתה את העבודה. קונגו נתנה פייט פיזי אדיר, אבל האיכות האנגלית (והחילופים של טוכל) הספיקו כדי להבטיח את הכרטיס לשמינית הגמר.` }, goals: [] },
    'match81': { timeStatus: 'past', matchday: 'r32', stage: "נוקאאוט", dateText: `01/07/2026 | 23:00 (שעון ישראל)`, teamHome: { name: `בלגיה`, flagCode: 'be', color: '#E30613', cards: { yellow: [], red: [] } }, teamAway: { name: `סנגל`, flagCode: 'sn', color: '#00853F', cards: { yellow: [], red: [] } }, score: { prediction: '2 - 2', actual: '3 - 2', accuracyClass: 'trend' }, probabilities: { home: 45, draw: 25, away: 30 }, matchRisk: 'Upset Alert', radarStats: { home: [85, 80, 75, 80, 75, 85], away: [75, 70, 70, 75, 90, 75] }, advancedStats: { home: { xG: '1.70', corners: 0 }, away: { xG: '1.50', corners: 0 } }, insight: { prediction: `משחק פתוח לחלוטין. בלגיה התקפית מאוד אך ההגנה שלה פגיעה מול העוצמה והמהירות של סנגל.`, actual: `משחק קצבי שהצדיק את התחזיות. בלגיה ניצלה את היתרון האיכותי שלה בהתקפה כדי לגבור על סנגל העיקשת בקרב רב שערים והעפילה לשלב הבא.` }, goals: [] },
    'match82': { timeStatus: 'past', matchday: 'r32', stage: "נוקאאוט", dateText: `02/07/2026 | 03:00 (שעון ישראל)`, teamHome: { name: `ארצות הברית`, flagCode: 'us', color: '#002868', cards: { yellow: [], red: [] } }, teamAway: { name: `בוסניה`, flagCode: 'ba', color: '#002F6C', cards: { yellow: [], red: [] } }, score: { prediction: '2 - 1', actual: '2 - 0', accuracyClass: 'trend' }, probabilities: { home: 55, draw: 25, away: 20 }, matchRisk: 'Safe', radarStats: { home: [75, 70, 65, 80, 75, 75], away: [65, 55, 70, 65, 85, 60] }, advancedStats: { home: { xG: '1.60', corners: 0 }, away: { xG: '1.10', corners: 0 } }, insight: { prediction: `ארה"ב מול הקהל הביתי חייבת לעבור. בוסניה קשוחה באוויר ותנסה לעקוץ במצבים נייחים.`, actual: `ארצות הברית שלטה לחלוטין וניצלה את הדחיפה מהקהל הביתי. בוסניה התקשתה לייצר מצבים, והאמריקאים ממשיכים הלאה עם ניצחון חלק.` }, goals: [] },
