...
const matchDatabase = {
    ...
    'match1': {
        ...
        advancedStats: { home: { xG: 1.84, restDays: 0, altitudeImpact: 'רגיל' }, away: { xG: 0.92, restDays: 0, altitudeImpact: 'בינוני' } },
    ...
    'match2': {
        ...
        advancedStats: { home: { xG: 0.65, restDays: 0, altitudeImpact: 'קשה' }, away: { xG: 2.10, restDays: 0, altitudeImpact: 'בינוני' } },
    ...
    'match3': {
        ...
        advancedStats: { home: { xG: 0.30, restDays: 0, altitudeImpact: 'קשה' }, away: { xG: 1.15, restDays: 0, altitudeImpact: 'קשה' } },
        insight: { prediction: "סערה מוקדמת מצד האיטי, שתדעך במחצית השנייה מול השליטה הסקוטית.", actual: "משחק דל במצבים (xG נמוך לשני הצדדים), הסקוטים עקצו מקרן כצפוי." },
    ...
    'match4': {
        ...
        advancedStats: { home: { xG: 1.60, restDays: 0, altitudeImpact: 'בינוני' }, away: { xG: 1.05, restDays: 0, altitudeImpact: 'קל' } },
        insight: { prediction: "ברזיל תשלוט בכדור, אך החוסן המנטלי של מרוקו יתסכל את ההתקפה.", actual: "המודל פגע בול! ברזיל התקשתה לתרגם את ה-xG לשערים מול ההגנה הקשוחה." },
    ...
    'match5': {
        ...
        advancedStats: { home: { xG: 3.12, restDays: 0, altitudeImpact: 'אין' }, away: { xG: 0.88, restDays: 0, altitudeImpact: 'קשה' } },
    ...
    'match6': {
        ...
        advancedStats: { home: { xG: 1.10, restDays: 0, altitudeImpact: 'קשה' }, away: { xG: 2.30, restDays: 0, altitudeImpact: 'בינוני' } },
        insight: { prediction: "הכישרון הטורקי יפגוש את האגרסיביות. מאבק עיקש.", actual: "הטורקים שלטו ביצירת המצבים (2.3 xG) וניצחו בצדק מוחלט." },
    ...
    'match7': {
        ...
        advancedStats: { home: { xG: 4.80, restDays: 0, altitudeImpact: 'קל' }, away: { xG: 0.15, restDays: 0, altitudeImpact: 'קשה' } },
        insight: { prediction: "שליטה גרמנית מוחלטת מול נבחרת שמתגוננת.", actual: "נתון xG פסיכי של 4.80 לגרמניה, שניצלה כל חצי הזדמנות לשחזור היסטורי." },
    ...
    'match8': {
        ...
        advancedStats: { home: { xG: 1.25, restDays: 0, altitudeImpact: 'בינוני' }, away: { xG: 0.95, restDays: 0, altitudeImpact: 'קל (רגילים לגובה)' } },
        insight: { prediction: "קרב אדיר על האמצע מרובה פיזיות, הכל מצביע על חלוקת נקודות.", actual: "משחק שקול (xG כמעט זהה), הוכרע בפעולה אישית של האלר." },
    ...
    'match9': {
        ...
        advancedStats: { home: { xG: 1.85, restDays: 0, altitudeImpact: 'קשה' }, away: { xG: 1.70, restDays: 0, altitudeImpact: 'בינוני' } },
        insight: { prediction: "הולנד תניע כדור בסבלנות מול היפנים העיקשים.", actual: "היפנים לא גנבו תיקו - ה-xG שלהם מראה שהם הגיעו למספיק מצבים כדי להבקיע פעמיים." },
    ...
    'match10': {
        ...
        advancedStats: { home: { xG: 3.10, restDays: 0, altitudeImpact: 'בינוני' }, away: { xG: 0.65, restDays: 0, altitudeImpact: 'קשה' } },
        insight: { prediction: "ההגנה התוניסאית קשוחה, אך העוצמה בכדורי גובה תשבור אותה.", actual: "העליונות השוודית באוויר ייצרה xG מפלצתי של מעל 3 שערים." },
    ...
    'match11': {
        ...
        advancedStats: { home: { xG: 1.45, restDays: 0, altitudeImpact: 'קשה' }, away: { xG: 1.95, restDays: 0, altitudeImpact: 'בינוני' } },
    ...
    'match12': {
        ...
        advancedStats: { home: { xG: 1.20, restDays: 0, altitudeImpact: 'בינוני' }, away: { xG: 0.45, restDays: 0, altitudeImpact: 'קשה' } },
    ...
    'match13': {
        ...
        advancedStats: { home: { xG: 2.40, restDays: 0, altitudeImpact: 'קל' }, away: { xG: 0.10, restDays: 0, altitudeImpact: 'בינוני' } },
    ...
    'match14': {
        ...
        advancedStats: { home: { xG: 1.15, restDays: 0, altitudeImpact: 'קל (רגילים לחום)' }, away: { xG: 1.90, restDays: 0, altitudeImpact: 'קשה' } },
