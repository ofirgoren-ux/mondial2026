// מסד הנתונים הרשמי - מונדיאל 2026 עם מודל הסתברות (Pro)
const matchDatabase = {
    'match1': {
    ...
    'match9': {
        ...
        insight: { prediction: "הולנד תניע כדור בסבלנות מול היפנים העיקשים.", actual: "היפנים לא גנבו תיקו - ה-xG שלהם מראה שהם הגיעו למספיק מצבים להבקיע פעמיים." },
    ...
    'match13': {
        ...
        insight: { prediction: "שליטה מוחלטת של ספרד בהחזקת הכדור. הטיקי-טאקה יכריע.", actual: "בונקר הירואי של קף ורדה! הספרדים החזיקו בכדור 80% מהזמן אבל לא כבשו." },
        goals: [],
        squads: { home: { predicted: [], actual: [] }, away: { predicted: [], actual: [] } }
    },
    ...
    'match14': {
        ...
        insight: { prediction: "ביאלסה ואורוגוואי יביאו לחץ גבוה שערב הסעודית לא תוכל לעמוד בו.", actual: "שחזור מונדיאל 2022! הסעודים היממו את אורוגוואי עם צמד במחצית השנייה." },
