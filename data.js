// מסד הנתונים הרשמי - מונדיאל 2026 (מסונכרן ללוח הזמנים הרשמי)
// 14 משחקים ששוחקו + 2 משחקים להמשך היום (16 ביוני)
...
const matchDatabase = {
    ...
    // --- 16 ביוני (טרום שריקה - יערכו בהמשך היום!) ---
    'match15': {
        ...
        goals: [],
        squads: { home: { predicted: ["מניאן", "קונדה", "אופמקאנו", "קונאטה", "ההרננדז", "טשואמני", "קמאבינגה", "גריזמן", "דמבלה", "אמבפה", "ז'ירו"], actual: [] }, away: { predicted: ["מנדי", "סבאלי", "קוליבאלי", "דיאלו", "ג'ייקובס", "גיי", "מנדי", "סאר", "מאנה", "דיא", "ג'קסון"], actual: [] } }
    },
    ...
    'match16': {
        ...
        goals: [],
        squads: { home: { predicted: ["קושטה", "קאנסלו", "דיאש", "סילבה", "מנדש", "פלהיניה", "פרננדש", "סילבה", "פליקס", "לאאו", "רונאלדו"], actual: [] }, away: { predicted: ["נדזילה", "רומאריק", "מבומבו", "איטואה", "מזינגה", "אביסו", "מאקוטה", "קיימבה", "גנבולה", "מבנזה", "אנדוקה"], actual: [] } }
    }
};
